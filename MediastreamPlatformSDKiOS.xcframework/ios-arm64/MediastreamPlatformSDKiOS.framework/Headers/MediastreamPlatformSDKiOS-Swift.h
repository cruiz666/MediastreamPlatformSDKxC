...
@interface MediastreamPlatformSDK (SWIFT_EXTENSION(MediastreamPlatformSDKiOS)) <GCKLoggerDelegate, GCKRemoteMediaClientListener, GCKRequestDelegate, GCKSessionManagerListener, GCKUIMediaControllerDelegate, GCKUIMiniMediaControlsViewControllerDelegate>
