...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://s3.amazonaws.com/mediastream-platform-sdk-ios/sdk/3.0.3.eu/3.0.3.eu.hotfix01/MediastreamPlatformSDKiOSxC.zip' }
